// Sample Additional Test 2 file for ArrMax.asm
...
set RAM[2048] 1111,  // Set Arr[0]
set RAM[2049] 2222,  // Set Arr[1]
set RAM[2050] 3333,  // Set Arr[2]
set RAM[2051] 4444;  // Set Arr[3]
